                    ...
                    <div className='card'>
                        <div className='card-body'>
                            ...
                            <div className='col-2'>
                                    ...
                                    <input type="text" name='id' className='form-control' required onChange={handleState} />
                                </div>
                                ...
                                <div className='col-4'>
                                    ...
                                    <input type="text" name='cep' className='form-control' onBlur={findCepUpdateClientes} onChange={handleState} />
                                </div>
